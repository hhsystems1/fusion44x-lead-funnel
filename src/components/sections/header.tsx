      ...
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-5 sm:h-16 sm:px-6 md:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-lg bg-brand-aqua px-4 py-2 text-sm font-semibold text-white transition-all duration-200 hover:bg-brand-aqua-light focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-aqua sm:px-5 sm:py-2.5"
          >
            Schedule a Call
          </button>
        </div>
